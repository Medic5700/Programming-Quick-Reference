...
def funcX(a):
    print(a)
funcX.test = 5
print("funcX.test = " + str(funcX.test))

#TODO a section on variable scope
print("=======================================================================")

def func0A(a : int, b : int, c : int) -> None: # function decliration, with full annotations
    """This is a docstring, used to tell what a function/class/module does, and will show up in the autogenerated documentation""" # it's good practice to use this
    # it is good practice for a docstring to be in the format of 'input reults in output' for the first line. IE:"""Do X and return a list."""
    ...
    global global_t1 # you can explicidly state global variables that can be used/modified
    local_t2 : int  = 5 # by annoatating a varable like this, the interpriter is explicidly creating a local variable in the function memory scope
    print("Function 0A: " + str(local_t2))
...
def func0B(a : int, b : int, c : int) -> None:
    global_t1 : str = "test"
    # in this case, even though 'global_t1' is a global variable, I am explicidly creating a local variable of the same name which will not effect the global variable
    print("Function 0B: " + str(global_t1))

global_t1 = 10
func0B(1, 2, 3)
print("Global = " + str(global_t1) + "\t# global variable not effected") # the global variable is unaffected
print("=======================================================================")
